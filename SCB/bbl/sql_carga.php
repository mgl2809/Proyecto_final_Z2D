...
//Buscar la Carga Actual de un alumno por nc
    ...
    public function BuscarCargaAlumno($nc) {
        ...
        $Encabezado = $Conexion->ejecutar("select carga.idCarga,
            materia. nombre as materia, docente.nombre as docente, 
            materia.ret_cvo, materia.clave, grupo.grupo,
...
//Listar Materias disponibles para un alumno
    ...
    public function MateriasDiponiblesCarrera($idcarrera, $semestre) {
        ...
        $Encabezado = $Conexion->ejecutar("SELECT carga.idCarga, 
            materia.nombre as materia, docente.nombre as docente, materia.ret_cvo, 
...
//Elimianr a un alumnos de una carga
    ...
    public function EliminarCargaAlumno($idCarga, $idAlumno) {
        ...
        $Conexion->ejecutar("delete from lista_alumnos where 
            Carga_idCarga =" . $idCarga . " and Alumno_idAlumno =" . $idAlumno . ";");
...
//Asigana la carga de un docente un grupo	
    ...
    public function AsiganrCargaDocente($docente, $grupo) {
        ...
        $Conexion->ejecutar("update carga set Docente_idDocente = " 
                . $docente . " where Grupo_idGrupo =" . $grupo . ";");
